 ...
 */
class PluginObfs : public IRacePluginComms {
public:
...
const char *const racePluginId = "PluginObfs";
const char *const racePluginDescription = "obfs plugin" BUILD_VERSION;
